  ...
  [
    ...
    body('password_confirm').custom((value, { req }) => {
      if (value !== req.body.password) {
        throw new Error('password_confirm does not match password');
      }
      return true;
    })
  ],
  ...
  [
    ...
    body('new_password_confirm').custom((value, { req }) => {
      if (value !== req.body.new_password) {
        throw new Error('new_password_confirm does not match new_password');
      }
      return true;
    })
  ],
...
router.get('/admin-only', auth, role('admin'), async (_req, res) => {
